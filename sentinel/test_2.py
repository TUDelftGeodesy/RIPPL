...
harmonie_data = '/media/gert/Data/weather_models/harmonie_data'
ecmwf_data = '/media/gert/Data/weather_models/ecmwf_data'
...
if track_no == 37:
    ...
    database_folder = '/media/gert/Data/radar_database/sentinel-1/dsc_t037'
    shapefile = '/media/gert/Data/GIS/shapes/netherlands/zuid_holland.shp'
    orbit_folder = '/media/gert/Data/orbits/sentinel-1'
    stack_folder = '/media/gert/Datastacks/radar_datastacks/sentinel-1/dsc_t037'
    polarisation = 'VV'
    mode = 'IW'
    product_type = 'SLC'
...
# t 88
    ...
    database_folder = '/media/gert/Data/radar_database/sentinel-1/asc_t088'
    shapefile = '/media/gert/Data/GIS/shapes/netherlands/netherland.shp'
    orbit_folder = '/media/gert/Data/orbits/sentinel-1'
    stack_folder = '/media/gert/Datastacks/radar_datastacks/sentinel-1/asc_t088'
    polarisation = 'VV'
    mode = 'IW'
    product_type = 'SLC'
...
n_jobs = 7
srtm_folder = '/media/gert/Data/DEM/dem_new'
...
# Unwrap and calc structure functions
