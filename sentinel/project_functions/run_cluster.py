...
sys.path.extend(['/home/gertmulder/software/Gert/doris_processing/sentinel'])
from sentinel_download import sentinel_available, sentinel_download, download_orbits, sentinel_check_validity

ROI = '/home/gertmulder/shapes/netherlands/netherland.shp'
orbit_folder = '/home/gertmulder/orbit'
destination_folder = '/home/gertmulder/radar_database/sentinel-1'
level = 'L1'
sensor_mode = 'IW'
product = 'SLC'
polarisation = 'VV VH'
...
while i == 1:
    ...
    invalid_files, valid_files = sentinel_check_validity(products, destination_folder=destination_folder, user=user, password=password, remove=True)
