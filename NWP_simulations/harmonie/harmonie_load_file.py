...
from rippl.NWP_simulations.model_reference import ModelReference
...
class HarmonieData(object):
    ...
    def load_harmonie(self, date, filename):
        ...
        dat_nums = ['11', '51', '76', '58']
        dat_types = ['Temperature', 'Specific humidity', 'Specific cloud liquid water content',
                     'Specific cloud ice water content']
        dat_names = ['Temperature', 'Specific humidity', 'Cloud water',
