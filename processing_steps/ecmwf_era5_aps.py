...
class EcmwfEra5Aps(HarmonieAps):
    """
    :type s_pix = int
    :type s_lin = int
    """
    ...
    def __init__(self, meta, cmaster_meta, coor_in, coordinates, s_lin=0, s_pix=0, lines=0,
                 weather_data_archive='', ecmwf_type='era5', time_interp='nearest', split=False, download=False):
        ...
        # For Sentinel-self.mask *= ~((self.lines == 0) * (self.pixels == 0))1 data this means a multilooking of about [50, 200]
