...
class EcmwfAps(object):
    ...
    def __init__(self, meta, cmaster_meta, coor_in, coordinates, s_lin=0, s_pix=0, lines=0,
        ...
        self.shape_out, self.lines, self.pixels = RadarDem.find_coordinates(meta, s_lin, s_pix, lines, self.coor_out)
        ...
        self.height = self.cmaster.image_load_data_memory('radar_DEM', s_lin, 0, self.shape_in, 'radar_DEM' + coor_in.sample)
        ...
        self.out_height = self.cmaster.image_load_data_memory('radar_DEM', s_lin, 0, self.shape_in, 'radar_DEM' + self.coor_out.sample)
