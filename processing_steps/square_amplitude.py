...
class SquareAmplitude(object):
    ...
    def __init__(self, meta, coreg_meta, coordinates, s_lin=0, s_pix=0, lines=0, step='earth_topo_phase', file_type=''):
    ...
    def add_meta_data(meta, coordinates, step='earth_topo_phase', file_type='earth_topo_phase'):
        ...
        type_str = 'square_amplitude' + coordinates.sample
        meta_info[type_str + '_input_step'] = step
        meta_info[type_str + '_input_file_type'] = file_type
        meta_info = coordinates.create_meta_data([type_str], ['complex_float'], meta_info)
