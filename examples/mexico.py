...
end_date = '2017-07-30'
master_date = '2017-07-19'

track_no = 143
database_folder = data_disk + 'radar_database/sentinel-1/s1_dsc_t143'
shapefile = data_disk + 'GIS/shapes/mexico/Mexicocity_4326.shp'
orbit_folder = data_disk + 'orbits/sentinel-1'
stack_folder = datastack_disk + 'radar_datastacks/sentinel-1/Mexico_t143'
polarisation = 'VV'
mode = 'IW'
product_type = 'SLC'
...
password = 'Radar2016'
username = 'gertmulder'
s1_stack.create_SRTM_input_data(srtm_folder, username, password, srtm_type='SRTM1')
...
coordinates = CoordinateSystem()
coordinates.create_radar_coordinates(multilook=[10, 40], offset=[0, 0], oversample=[1, 1])
coordinates.slice = False
