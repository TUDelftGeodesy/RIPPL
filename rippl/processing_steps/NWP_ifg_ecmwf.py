...
class InterferogramEcmwf(Process):  # Change this name to the one of your processing step.
    ...
    def __init__(self, data_id='', polarisation='',
        ...
        self.output_info['process_name'] = 'ecmwf_interferogram'
        self.output_info['image_type'] = 'ifg'
        self.output_info['polarisation'] = polarisation
        self.output_info['data_id'] = data_id
        self.output_info['coor_type'] = 'out_coor'
        self.output_info['file_types'] = ['ecmwf_interferogram']
        self.output_info['data_types'] = ['real4']

        # Input data information
        self.input_info = dict()
        self.input_info['image_types'] = ['slave', 'master']
        self.input_info['process_types'] = ['ecmwf_aps', 'ecmwf_aps']
        self.input_info['file_types'] = ['ecmwf_aps', 'ecmwf_aps']
    ...
    def init_super(self):
        ...
        super(InterferogramEcmwf, self).__init__(
    ...
    def process_calculations(self):
        ...
        self['ecmwf_interferogram'] = self['slave'] - self['master']
