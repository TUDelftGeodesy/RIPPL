...
class InterferogramEcmwf(Process):  # Change this name to the one of your processing step.
    ...
    def __init__(self, data_id='', polarisation='',
        ...
        self.output_info['file_names'] = ['ecmwf_interferogram']
        self.output_info['data_types'] = ['real4']

        # Input data information
        self.input_info = dict()
        self.input_info['image_types'] = ['secondary_slc', 'primary_slc']
        self.input_info['process_names'] = ['ecmwf_aps', 'ecmwf_aps']
        self.input_info['file_names'] = ['ecmwf_aps', 'ecmwf_aps']
    ...
    def process_calculations(self):
        ...
        self['ecmwf_interferogram'] = self['secondary_slc'] - self['primary_slc']
