...
class InterferogramHarmonie(Process):  # Change this name to the one of your processing step.
    ...
    def __init__(self, data_id='', out_coor=[], secondary_slc='secondary_slc',  primary_slc='primary_slc',
                 reference_slc='reference_slc', ifg='ifg', overwrite=False):
        ...
        self.output_info['file_names'] = ['harmonie_interferogram']
        self.output_info['data_types'] = ['real4']

        # Input data information
        self.input_info = dict()
        self.input_info['image_types'] = ['secondary_slc', 'primary_slc']
        self.input_info['process_names'] = ['harmonie_aps', 'harmonie_aps']
        self.input_info['file_names'] = ['harmonie_aps', 'harmonie_aps']
    ...
    def process_calculations(self):
        ...
        self['harmonie_interferogram'] = self['secondary_slc'] - self['primary_slc']
