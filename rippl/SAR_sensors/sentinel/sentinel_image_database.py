...
If there is a primary burst file this can be loaded to compare with new bursts. Otherwise
you can create a new primary burst file.
...
class SentinelDatabase(object):
    ...
    def __call__(self, database_folder='', shapefile='', track_no='',
        ...
        if not database_folder:
            ...
            radar_database = settings.settings['paths']['radar_database']
            folder = settings.settings['path_names']['SAR']['Sentinel-1']
    ...
    def extract_manifest_files(self):
        ...
        for zip_image in self.zip_images:
            try:
                ...
                logging.warning('Failed to read from: ' + zip_image + ' ' + str(e))
    ...
    def select_overlapping(self, shapefile, buffer=0.02):
        ...
        self.reference_shape = copy.deepcopy(shape)
