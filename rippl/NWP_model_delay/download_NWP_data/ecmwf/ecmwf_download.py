...
from rippl.NWP_model_delay.download_NWP_data.ecmwf.ecmwf_mars_request import MarsRequest
...
class ECMWFdownload(ECMWFType):
    ...
    def __init__(self, latlim, lonlim, ecmwf_data_folder, data_type='era_interim', processes=8):
        ...
        try:
            ...
            ImportError('Cannot import ecmwfapi')
    ...
    def prepare_download(self, dates):
        ...
        type2str = {'reanalysis-era5-complete': '_era5_', 'oper': '_oper_'}

        # Define output filenames
        self.filenames = []
        
        if self.data_type in ['reanalysis-era5-complete']:
